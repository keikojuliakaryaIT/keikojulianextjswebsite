"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[691],{6055:function(e,t,i){i.d(t,{ab:function(){return e6},o:function(){return ii},y:function(){return e8}});var r,n=i(8885),s=i(3943),a=i(9053),o=i(1735),l=i(2680);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e9(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function e6(e,t,i){return(0,n.rh)(e.app)?Promise.reject(g(e)):e5((0,s.m9)(e),eq.credential(t,i)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e9(e),t})}function e8(e,t,i,r){return(0,s.m9)(e).onAuthStateChanged(t,i,r)}new WeakMap;let e7="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
